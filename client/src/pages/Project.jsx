...
// If you import from a JSON file:
// import projects from '../data/projects.json';

// Or define projects array inline here:
const projects = [
  {
    title: "Personal Portfolio",
    description: "A modern, responsive portfolio website built with React and styled-components.",
    tech: ["React", "styled-components", "Vercel"],
    live: "https://your-portfolio.com",
    github: "https://github.com/yourusername/portfolio"
  },
  {
    title: "Accent Analyzer",
    description: "A Gradio-powered web app for detecting English speaker accents from .mp4 video files by extracting audio and comparing embeddings.",
    tech: ["Python", "Gradio", "Speech Embeddings", "Hugging Face"],
    live: "https://huggingface.co/spaces/nwankwolinus/accent_analyzer",
    github: "https://github.com/nwankwolinus/accent_analyzer"
  }
];
...
const Project = () => (
  <section className="projects-section" id="projects">
    ...
    {/* Add some basic styles or import your CSS */}
    <style>{`
      .projects-section {
        padding: 48px 0;
        background: #18192b;
